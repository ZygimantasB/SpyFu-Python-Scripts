...
class SpyFuAPI:
    ...
    def prepare_parameters(self, search_criteria: dict) -> dict:
        ...
        if 'url' in search_criteria and 'terms' in search_criteria:
            ...
            params = {
                ...
                'countryCode': "UK",
                'adultFilter': True,
                'onlyAdultKeywords': False,
                'excludeAdultKeywords': False,
                'keywordDifficulty.min': 0,
                'keywordDifficulty.max': 100,
                'adCount.min': 0,
                'adCount.max': 1000,
                'searchVolume.min': 1,
                'searchVolume.max': 10000,
                'includeTerms': cleaned_terms,
                'includeAnyTerm': True,
                'excludeTerms': "",
            }
        else:
    ...
    def get_spy_fu_data(self):
        ...
        """
        url = self.api_url + "/serp_api/v2/seo/getMostValuableKeywords"
        all_data = {}
